...
public class CursorAnchorScript : MonoBehaviour
{
	...
	public void SetHoverText(string text)
	{
		...
		// set size
		float targetWidth = LayoutUtility.GetPreferredWidth(hoverTextText.rectTransform);
		float targetHeight = LayoutUtility.GetPreferredHeight(hoverTextText.rectTransform);
